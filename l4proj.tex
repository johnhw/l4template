...
% You can use \todo{} to mark text that needs to be fixed. They will appear in large orange 
...
\footnote{Specifying an online resource like `https://developer.android.com/studio`
...
derived requirements. In research projects, it will involve developing a design drawing on
