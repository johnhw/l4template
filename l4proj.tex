...
% then insert your name and the date below to 
% sign the education use form that appears in the front of the document. 
% You must explicitly give consent.
%
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{images/boxplot_finger_distance.pdf}    
